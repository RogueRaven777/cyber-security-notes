...
2> /dev/null (এরর লুকানো): যেকোনো কাজের অপ্রয়োজনীয় এরর/ভুল মেসেজ লিনাক্সের ময়লার ঝুড়িতে (/dev/null) পাঠিয়ে স্ক্রিন পরিষ্কার রাখে।
...
cut -d ":" -f 1 /etc/passwd: নির্দিষ্ট চিহ্ন (:) দিয়ে ভাগ করে ১ম কলামের ডাটা কেটে বের করে।
